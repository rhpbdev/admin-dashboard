    ...
    <>
        ...
        <div className="container mx-auto text-center max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <p className="text-slate-600">
                Once you're satisfied, download your design as a print-ready PDF
                or share it digitally with ease.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                // imageSrc is now illustrative, actual image is placeholder.webp
              },
              {
              ...
              >
                <div className="w-full h-48 bg-slate-200 flex items-center justify-center relative">
                  {' '}
                  {/* Added relative for Next/Image fill */}
                  <Image
                    src="/placeholder.webp" // Use the local placeholder
                    alt={template.title}
                    layout="fill" // Fills the parent container
                    objectFit="cover" // Behaves like background-size: cover
                    className="transition-transform duration-300 ease-in-out group-hover:scale-105" // Added group-hover directly if Card is the group
                  />
                </div>
                <CardHeader>
      ...
      <section id="testimonials" className="py-24 px-6 md:px-16 bg-slate-50">
        <div className="container mx-auto text-center max-w-5xl">
          ...
          <p className="text-lg text-slate-600 mb-16 max-w-3xl mx-auto">
            Hear how we've helped families create meaningful tributes during
            their time of need.
          </p>
            ...
            <Card className="bg-white shadow-lg">
              ...
              <CardContent>
                <p className="text-slate-600 italic">
                  ...
                  beautiful program for my father's service so much easier. The
                  templates were lovely and easy to customize. Thank you!"
                </p>
              </CardContent>
              <CardFooter>
